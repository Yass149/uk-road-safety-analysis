...
Bash
git clone https://github.com/your-username/uk-road-safety-analysis.git
Install dependencies:

Bash
pip install pandas matplotlib seaborn
Open the notebook:
Launch Analysis.ipynb in Jupyter or VS Code to view the full pipeline.

Author
Yassine Malal MSc Data Science Student | University of Reading
